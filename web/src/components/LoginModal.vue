<template>
  ...
  <div style="text-align: center">
    <router-link to="#" data-bs-toggle="modal" data-bs-target="#login">get</router-link>
  </div>
  <!-- Modal -->
  <div class="modal fade" id="login" tabindex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="overlay-container">
            <div class="overlay">
              <div class="overlay-panel overlay-left">
                ...
                <button class="ghost login-button" @click="ToActive()" id="signIn">Sign In</button>
              </div>
              <div class="overlay-panel overlay-right">
                <h1>Hello,Friend!</h1>
                <p>Enter your personal details and start journey with us</p>
                <button class="ghost login-button" @click="ToActive()" id="signUp">Sign Up</button>
              </div>
            </div>
          </div>
        </div>
