...
import com.blogbackend.service.impl.article.utils.PathUtils;
import com.blogbackend.service.user.UploadService;
...
public class UploadImpl implements UploadService {
    @Override
    public RespResult uploadImg(MultipartFile img) {
        //判断文件类型
        //获取原始文件名
        ...
        return RespResult.fail(200,url);
    }
